 ...
 */
public interface RequerimentoConvalidacaoRepository extends JpaRepository<RequerimentoConvalidacao, Long>, JpaSpecificationExecutor<RequerimentoConvalidacao> {
    @Transactional
    @Modifying
