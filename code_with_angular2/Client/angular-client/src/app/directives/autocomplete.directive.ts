import {
  ComponentRef, Directive, ElementRef, EventEmitter, HostListener, Injector, Input, OnInit, Output, Provider,
  Renderer
} from "@angular/core";
import {NgModel} from "@angular/forms";
import {AutocompleteUtils} from "./sanatize";
...
export class Autocomplete implements OnInit {
  ...
  show(matches:Array<any>) {
    ...
    this.popup = this.loader.loadNextToLocation(AutocompleteContainer, this.element, binding)
